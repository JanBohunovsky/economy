...
// Code taken from MerchantScreenHandler
public class ShopVillagerScreenHandler extends ScreenHandler {
    ...
    public ShopVillagerScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        ...
        this.setOffers(TradeOfferList.fromPacket(buf));
        this.setLevelProgress(buf.readVarInt());
        this.setExperienceFromServer(buf.readVarInt());
        this.setCanLevel(buf.readBoolean());
        this.setRefreshTrades(buf.readBoolean());
    }

    public ShopVillagerScreenHandler(int syncId, PlayerInventory playerInventory, Merchant merchant) {
        super(ModScreens.SHOP_VILLAGER, syncId);
        System.out.println(merchant.getClass().toString());
